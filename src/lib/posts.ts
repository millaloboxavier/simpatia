...
export const posts: Post[] = [
  ...
  },
  {
    ...
    excerpt:
      "O passo a passo tradicional da simpatia mais compartilhada entre amigas — e como a versão digital do SimpatIA recria essa experiência.",
    ...
    content: [
      ...
      "No SimpatIA, a lógica é a mesma, mas com acompanhamento: você vê os dias passando, o gelo se formando visualmente, e tem um momento de fechamento — descongelar — quando sentir que já resolveu.",
    ],
  },
  {
    ...
    content: [
      ...
      "Em breve, essas simpatias também vão ganhar vida no SimpatIA — cada uma com sua própria forma de acompanhar o tempo e comemorar o resultado.",
    ],
  },
];
